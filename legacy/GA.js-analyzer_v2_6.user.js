// ==UserScript==
// @name GA Analyzer GA.js script v2.6
...
{ 
  ...
  if (calls_on_site == 1 ) { msg("<span style='color: #FFFF00;'>" + calls_on_site + "</span> pageTracker call found, need minimal 2 pageTracker calls"); }
