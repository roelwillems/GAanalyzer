// ==UserScript==
// @name GA Analyzer GA.js script v2.5.2
...
{ msg("<br><br><span style='color: #FF0000;'>No</span> Adwords conversion script found"); }
else if  (adwords_on_site == "true")
{ 
  msg("<br><br><strong>ONPAGE:</strong><br>");
  
  msg("Call to Adwords conversion script found"); 
} 
