...
var ecommerce_on_site = ""; 
var ecommerce_on_site_urchin = ""; 
var ecommerce_on_site_check = ""; 
var ecommerce_on_site_check_urchin = ""; 
var ecommerce_secure_script = "false";
var addtrans_order_id = "";
var addtrans_order_affiliation = "";
var addtrans_order_total_trans = "";
var addtrans_order_tax = "";
var addtrans_order_shipping = "";
var addtrans_order_city = "";
var addtrans_order_state = "";
var addtrans_order_country = "";

    
  if (i.innerHTML)
  { 
   
ecommerce_on_site_check_urchin = /(\s)*__utmSetTrans\(\)*/gi.exec(i.innerHTML);
		if (ecommerce_on_site_check_urchin) { ecommerce_on_site_urchin = "GA.js"; }
ecommerce_on_site_check = /(\s)*pageTracker\.\_trackTrans\(\)*/gi.exec(i.innerHTML);
		if (ecommerce_on_site_check) { ecommerce_on_site = "GA.js"; }		
...
conversion_lab = /(\s)*var(\s)google_conversion_label(\s)=(\s)(.*)/gi.exec(i.innerHTML);
 ...
 if (ecommerce_on_site == "urchin.js")
{ 
msg("<br><strong>GOOGLE ANALYTICS ECOMMERCE:</strong><br>");

msg("Urchin.js call to Analytics ecommerce script found<br>"); }

else if  (ecommerce_on_site == "GA.js")
{ 
  msg("<br><strong>GOOGLE ANALYTICS ECOMMERCE:</strong><br>");
  
  msg("GA.js call to Analytics ecommerce script found<br>"); 

  { msg("Order id: <span style='color: #FFFF00;'>" + addtrans_order_id + "</span>"); }
  { msg("Order affiliation: <span style='color: #FFFF00;'>" + addtrans_order_affiliation + "</span>"); }  
  { msg("Order total transaction value: <span style='color: #FFFF00;'>" + addtrans_order_total_trans + "</span>"); }
  { msg("Order tax: <span style='color: #FFFF00;'>" + addtrans_order_tax + "</span>"); }
  { msg("Order Shipping: <span style='color: #FFFF00;'>" + addtrans_order_shipping + "</span>"); }  
  { msg("Order city: <span style='color: #FFFF00;'>" + addtrans_order_city + "</span>"); }    
  { msg("Order state: <span style='color: #FFFF00;'>" + addtrans_order_state + "</span>"); }    
  { msg("Order country: <span style='color: #FFFF00;'>" + addtrans_order_country + "</span>"); }    
} 
