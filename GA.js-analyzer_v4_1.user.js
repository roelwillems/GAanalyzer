// ==UserScript==
// @name GA Analyzer GA.js script v4.2
...
// _setAccount
  calls_on_site1 = 0;
  if(trackercalls1 = document.getElementsByTagName("html")[0].innerHTML.match(/\_setAccount/g))
  {
    calls_on_site1 = trackercalls1.length;
  }
  if (calls_on_site1 == 0 ) { msg("</br><span style='color: #FF0000;'> No _setAccount found!</span>"); }
  else if (calls_on_site1 == 1 ) { msg("</br><span style='color: #FFFFFF;'> _setAccount found</span>"); }
...
// _gaq.push
  calls_on_site2 = 0;
  if(trackercalls2 = document.getElementsByTagName("html")[0].innerHTML.match(/\_gaq\.push/g))
  {
    calls_on_site2 = trackercalls2.length;
  }
  if (calls_on_site2 == 0 ) { msg("</br><span style='color: #FFFF00;'> No _gaq.push found!</span>"); }
  else if (calls_on_site2 == 1 ) { msg("</br><span style='color: #FF0000;'> One _gaq.push found, check source code</span>"); }
  else { msg("</br><span style='color: #FFFFFF;'>" + calls_on_site2 + "</span> _gaq.push calls found");}
...
// _trackPageLoadTime
  ...
  if (calls_on_site5 == 0 ) { msg("<span style='color: #FFFF00; margin-left: 10px;'> No _trackPageLoadTime found,</span></br><span style=' margin-left: 10px;'>consider adding it to measure site loadtime performance</span>"); }
...
// _getTracker
  ...
  else { msg("</br><span style='color: #FF0000;'>_getTracker found</span> function is deprecated. Please use _gat._createTracker() instead."); }
